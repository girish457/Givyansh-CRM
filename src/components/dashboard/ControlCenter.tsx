...
export default function ControlCenter() {
  ...
  // Tab states
  const [activeTab, setActiveTab] = useState<"shifts" | "allotment" | "gamification">("shifts");
    ...
    return (
      <div style={{ height: "450px", display: "flex", justifyContent: "center", alignItems: "center" }}>
        <div style={{ textAlign: "center" }}>
          <LucideCpu size={48} className="animate-spin" color="#2563eb" style={{ margin: "0 auto 15px" }} />
          <p style={{ color: "#475569", fontWeight: 700 }}>Synchronizing Shift Governance Node...</p>
        </div>
      </div>
    );
  }
      ...
      {activeTab === "shifts" ? (
        ...
        <div>
          <div className="flex-between mb-medium" style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "20px" }}>
            ...
            <button className="btn-primary" onClick={() => { setEditingShift(null); setFormData({ name: "", startTime: "10:00", endTime: "18:00", requiredHours: "8", lunchStartTime: "13:30", lunchEndTime: "14:00", earlyLoginAllowed: 60, postShiftAllowed: 120 }); setModalSelectedEmployeeIds([]); setModalSearchText(""); setModalRoleFilter("all"); setShowModal(true); }}>
              ...
              return (
                ...
                >
                  ...
                  <div style={{ display: "flex", gap: "10px", borderTop: "1px solid #f1f5f9", paddingTop: "14px" }}>
                    <button 
                      onClick={() => { setEditingShift(shift); setFormData(shift); setModalSelectedEmployeeIds(getEmployeesForShift(shift.id).map(e => e.id)); setModalSearchText(""); setModalRoleFilter("all"); setShowModal(true); }}
                      style={{ 
                        flex: 1, 
                        padding: "10px", 
                        borderRadius: "12px", 
