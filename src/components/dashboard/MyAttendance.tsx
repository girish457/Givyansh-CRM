...
import { 
  ...
  LucideAward, LucideChevronRight, LucideFilter, LucideChevronLeft
} from "lucide-react";
            ...
            >
              ...
              {loadingModal ? (
                <div style={{ textAlign: "center", padding: "40px 0" }}>
                  <div style={{ display: "inline-block", width: "24px", height: "24px", border: "3px solid #e2e8f0", borderTopColor: "#2563eb", borderRadius: "50%", animation: "spin 1s linear infinite" }} />
                  <p style={{ color: "#64748b", marginTop: "10px", fontWeight: 600 }}>Fetching logs...</p>
                </div>
              ) : !modalAttendance ? (
