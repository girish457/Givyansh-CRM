...
export default function SupervisorFeedbackTab({ role, currentUser }: SupervisorFeedbackTabProps) {
  ...
  const [currentListTab, setCurrentListTab] = useState<"Unread" | "Read" | "Replied">("Unread");
  ...
  }, [feedbacks, searchQuery, datePreset, customStartDate, customEndDate]);
  ...
  const stats = useMemo(() => {
    ...
    return { total, unread, read, replied, anonymous };
  ...
  return (
    <div style={{ padding: "24px", background: "#f8fafc", minHeight: "100%", fontFamily: "'Outfit', sans-serif", overflowY: "auto" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "24px", flexWrap: "wrap", gap: "12px" }}>
        ...
        {/* Global Action items for Excel/PDF */}
          ...
          {role !== "tl" && (
            <>
              ...
              <button 
                ...
                style={{ padding: "8px 14px", borderRadius: "10px", border: "none", background: "linear-gradient(135deg, #2563eb 0%, #1d4ed8 100%)", color: "white", fontWeight: 700, fontSize: "0.8rem", cursor: "pointer", display: "inline-flex", alignItems: "center", gap: "6px", boxShadow: "0 4px 12px rgba(37,99,235,0.15)" }}
              >
                <LucidePrinter size={14} /> Export PDF
              </button>
            </>
          )}
          <button
            onClick={() => setShowAnalyticsTab(!showAnalyticsTab)}
            style={{ padding: "8px 14px", borderRadius: "10px", border: "1.5px solid #2563eb", background: showAnalyticsTab ? "#eff6ff" : "white", color: "#2563eb", fontWeight: 800, fontSize: "0.8rem", cursor: "pointer", display: "inline-flex", alignItems: "center", gap: "6px" }}
          >
            <LucideBarChart3 size={14} /> {showAnalyticsTab ? "Close Analytics" : "View Analytics"}
          </button>
        </div>
      </div>
      ...
      {showAnalyticsTab ? (
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1.2fr 1fr", gap: "24px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
            ...
            <div style={{ background: "white", padding: "24px", borderRadius: "24px", border: "1px solid #e2e8f0", minHeight: "450px" }}>
              <div style={{ display: "flex", borderBottom: "1.5px solid #cbd5e1", gap: "20px", marginBottom: "16px" }}>
                {(["Unread", "Read", "Replied"] as const).map(tab => {
          ...
          {/* RIGHT CONTAINER: Detail timeline conversation */}
          <div style={{ background: "white", padding: "24px", border: "1px solid #e2e8f0", borderRadius: "24px", height: "fit-content", minHeight: "550px", display: "flex", flexDirection: "column" }}>
            
            {selectedFeedback ? (
              <div style={{ display: "flex", flexDirection: "column", height: "100%", flex: 1, gap: "16px" }}>
                
                {/* Header details */}
                <div style={{ display: "flex", justifyContent: "space-between", borderBottom: "1px solid #f1f5f9", paddingBottom: "14px", alignItems: "center" }}>
                ...
                <div style={{ flex: 1, minHeight: "200px", maxHeight: "300px", overflowY: "auto", background: "#f8fafc", padding: "10px", borderRadius: "16px", border: "1px solid #cbd5e1", display: "flex", flexDirection: "column", gap: "10px" }}>
                      ...
                      return (
                        ...
                        >
                          <span style={{ fontSize: "0.62rem", fontWeight: 800, opacity: 0.8, marginBottom: "2px" }}>
                            {reply.senderRole === "recruiter" && selectedFeedback.isAnonymous 
                              ? "Anonymous Employee" 
                ...
                <form onSubmit={handleSendReply} style={{ display: "flex", gap: "6px" }}>
                  <input
                    ...
                    placeholder="Type reply reflections..."
                    style={{ flex: 1, padding: "8px 12px", borderRadius: "8px", border: "1px solid #cbd5e1", fontSize: "0.78rem", outline: "none" }}
                  />
                  <button
                    type="submit"
                    disabled={submittingReply}
                    style={{ padding: "8px 14px", borderRadius: "8px", background: "#2563eb", color: "white", border: "none", cursor: "pointer", display: "flex", alignItems: "center", gap: "2px", fontWeight: 700, fontSize: "0.78rem" }}
                  >
                    Reply
                  </button>
                </form>
              ...
              <div style={{ margin: "auto", textAlign: "center", color: "#94a3b8", display: "flex", flexDirection: "column", alignItems: "center", gap: "10px" }}>
                <LucideInbox size={40} style={{ opacity: 0.4 }} />
                <span style={{ fontSize: "0.8rem", fontWeight: 600 }}>Select a feedback card from the list to read detailed threads and reply.</span>
              </div>
            )}
