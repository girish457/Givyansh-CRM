...
export default function AdminLayout({ children, role, userName = "Girish G.", activeTab, onTabChange }: AdminLayoutProps) {
  ...
  useEffect(() => {
    ...
    const intervalNotifs = setInterval(fetchNotifs, 15000);
  ...
  const menuItems = {
    ...
    boss: [
      { id: "dashboard", name: "Dashboard", icon: <LucideLayoutDashboard size={18} />, href: "/dashboard/boss" },
      ...
      { id: "inbox", name: "Reporting AI", icon: <LucideMail size={18} />, href: "/dashboard/boss/inbox" },
    ...
    recruiter: [
      { id: "dashboard", name: "Dashboard", icon: <LucideLayoutDashboard size={18} />, href: "/dashboard/recruiter" },
    ...
    tl: [
      { id: "dashboard", name: "Dashboard", icon: <LucideLayoutDashboard size={18} />, href: "/dashboard/tl" },
    ...
    manager: [
      { id: "dashboard", name: "Dashboard", icon: <LucideLayoutDashboard size={18} />, href: "/dashboard/manager" },
  ...
  const dashboardLink = role === "superadmin" ? "/superadmin/dashboard" : `/dashboard/${role}`;
