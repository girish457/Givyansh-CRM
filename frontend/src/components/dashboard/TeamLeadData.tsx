...
import { 
  ...
  LucidePieChart, LucideAward, LucideZap, LucideListTodo, LucideLoader2
} from "lucide-react";
  ...
  if (loading) {
    return (
      <div style={{ display: "flex", justifyContent: "center", alignItems: "center", height: "calc(100vh - 120px)", background: "#f8fafc", flexDirection: "column", gap: "15px" }}>
        ...
        <span style={{ fontSize: "1.1rem", fontWeight: 800, color: "#64748b" }}>Loading Team Lead Data...</span>
      </div>
    );
  }
