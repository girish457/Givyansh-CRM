...
export default function Jobs({ role }: { role: string }) {
  ...
  const startEditing = (job: Job) => {
    ...
    setNewJob({
      title: job.title || "",
      clientId: job.clientId ? String(job.clientId) : (job.client?.id ? String(job.client.id) : ""),
      clientIds: job.clientId ? [String(job.clientId)] : (job.client?.id ? [String(job.client.id)] : []),
              ...
              <div className="form-group-v2">
                 ...
                 <select 
                    ...
                    onChange={e => {
                        ...
                        setNewJob({...newJob, clientIds: values, clientId: values[0] || ""});
                    }} 
                    className="select-v2"
          ...
          <div style={{ display: "grid", gridTemplateColumns: "280px 1fr", gap: "1rem", alignItems: "start" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "0.75rem" }}>
              ...
              <div style={{ background: "white", padding: "1rem", borderRadius: "16px", border: "1px solid #e2e8f0" }}>
                 ...
                 <div style={{ color: "#475569", lineHeight: "1.4", whiteSpace: "pre-wrap", fontSize: "0.78rem", background: "#f8fafc", padding: "10px 12px", borderRadius: "10px", border: "1px solid #cbd5e1", wordBreak: "break-word", overflowWrap: "anywhere" }}>
