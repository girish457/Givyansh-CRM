                    ...
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "8px" }}>
                      ...
                      {uniqueCats.length > 0 && (
                        <button
                          type="button"
                          onClick={() => {
                            const allSelected = selectedCategories.length === uniqueCats.length;
                            setSelectedCategories(allSelected ? [] : [...uniqueCats]);
                          }}
                          style={{
                            background: "none",
                            border: "none",
                        ...
                        >
                          {selectedCategories.length === uniqueCats.length ? "Deselect All" : "Select All"}
                        </button>
                      )}
                    </div>
