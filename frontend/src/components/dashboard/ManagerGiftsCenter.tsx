...
import {
  ...
  LucideCheck, LucideTicket, LucideCoffee, LucideCreditCard, LucideShoppingBag, LucideLoader2
} from "lucide-react";
...
export default function ManagerGiftsCenter({ role = "manager" }: { role?: "manager" | "boss" }) {
  ...
  const theme = {
    container: { padding: "12px 16px", color: "#1e293b", fontFamily: "'Inter', sans-serif" },
    card: { padding: "16px", borderRadius: "16px", background: "#ffffff", border: "1px solid #e2e8f0", color: "#1e293b", boxShadow: "0 4px 20px rgba(0,0,0,0.02)" },
    smallCard: { padding: "10px 14px", borderRadius: "12px", border: "1px solid #e2e8f0", background: "#ffffff", display: "flex", justifyContent: "space-between", alignItems: "center", boxShadow: "0 4px 15px rgba(0,0,0,0.03)", color: "#0f172a" },
    inputBg: "#ffffff",
    inputText: "#0f172a",
    inputBorder: "#cbd5e1",
    subBg: "#f8fafc",
    subBorder: "1px solid #e2e8f0",
    textMuted: "#64748b",
    headingColor: "#0f172a",
    borderColor: "#f1f5f9",
    itemBg: "#ffffff",
  ...
  if (loading) {
    return (
      <div style={{ display: "flex", justifyContent: "center", alignItems: "center", height: "calc(100vh - 120px)", background: "#f8fafc", flexDirection: "column", gap: "15px" }}>
        ...
        <span style={{ fontSize: "1.1rem", fontWeight: 800, color: "#64748b" }}>Loading Gift Hub...</span>
      </div>
    );
  }
    ...
    <div className="gifts-command-hub" style={theme.container}>
      ...
      <div
        ...
        style={{
          ...
          borderRadius: "16px",
          marginBottom: "16px",
          border: isBoss ? "1px solid rgba(251, 191, 36, 0.3)" : "1px solid rgba(244, 63, 94, 0.2)",
          position: "relative",
          overflow: "hidden",
          boxShadow: isBoss ? "0 10px 25px rgba(15, 23, 42, 0.4)" : "0 10px 25px rgba(76, 5, 25, 0.1)"
        }}
      >
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          <div>
            <span style={{ background: isBoss ? "rgba(251, 191, 36, 0.15)" : "rgba(244,63,94,0.2)", color: isBoss ? "#fbbf24" : "#f43f5e", fontSize: "0.6rem", fontWeight: 800, padding: "3px 8px", borderRadius: "20px", border: isBoss ? "1px solid rgba(251, 191, 36, 0.3)" : "1px solid rgba(244,63,94,0.3)", textTransform: "uppercase", letterSpacing: "1px" }}>
              🏆 Enterprise Recognition Node
            </span>
            <h1 style={{ fontSize: "1.25rem", fontWeight: 950, marginTop: "6px", letterSpacing: "-0.5px", margin: "6px 0 0" }}>
              Employee Rewards & Incentives Center
            </h1>
            <p style={{ color: isBoss ? "#cbd5e1" : "#94a3b8", fontSize: "0.74rem", marginTop: "2px", maxWidth: "600px", margin: 0 }}>
        ...
        <div style={{ display: "flex", gap: "8px", marginTop: "12px", borderTop: "1px solid rgba(255,255,255,0.1)", paddingTop: "10px" }}>
          {[
            { id: "distribute", name: "Distribute Incentives", icon: <LucidePlus size={14} /> },
            { id: "history", name: "Disbursed History Log", icon: <LucideFileText size={14} /> },
            { id: "leaderboard", name: "Gamification & Leaderboard", icon: <LucideTrophy size={14} /> }
          ].map(tab => (
            <button
              key={tab.id}
              ...
              style={{
                ...
                boxShadow: activeTab === tab.id ? (isBoss ? "0 4px 10px rgba(251, 191, 36, 0.15)" : "0 4px 10px rgba(244, 63, 94, 0.15)") : "none"
              }}
            >
              {tab.icon}
              {tab.name}
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(5, 1fr)", gap: "10px", marginBottom: "12px" }}>
        {[
          ...
          >
            <div>
              <span style={{ fontSize: "0.58rem", color: theme.textMuted, fontWeight: 700, textTransform: "uppercase" }}>{c.title}</span>
              <h3 style={{ fontSize: "1rem", fontWeight: 950, color: theme.inputText, marginTop: "2px", margin: 0 }}>{c.val}</h3>
            </div>
            <div style={{ width: "30px", height: "30px", borderRadius: "8px", background: isBoss ? "rgba(251, 191, 36, 0.15)" : `${c.color}15`, display: "flex", alignItems: "center", justifyContent: "center", fontSize: "0.95rem", color: isBoss ? "#fbbf24" : "inherit" }}>
              {c.icon}
            </div>
          </div>
        ))}
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(5, 1fr)", gap: "10px", marginBottom: "12px" }}>
        {[
          ...
          >
            <span style={{ fontSize: "0.65rem", fontWeight: 700, color: theme.textMuted }}>{c.title}</span>
            <span style={{ fontSize: "0.8rem", fontWeight: 900, color: c.color }}>{c.val}</span>
          </div>
        ))}
      </div>
        ...
        {activeTab === "distribute" && (
          ...
          >
            ...
            <form onSubmit={triggerGiftDistribution} className="glass-card" style={theme.card}>
              <h2 style={{ fontSize: "0.95rem", fontWeight: 900, color: theme.headingColor, borderBottom: `1px solid ${theme.borderColor}`, paddingBottom: "8px" }}>
                🎁 Reward Generation & Target Allocation
              </h2>

              {/* Recipient Target options */}
              <div style={{ marginTop: "12px" }}>
                <label style={{ display: "block", fontSize: "0.68rem", fontWeight: 800, color: theme.textMuted, textTransform: "uppercase" }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "8px", marginTop: "8px" }}>
                  {[
                    ...
                    >
                      <strong style={{ fontSize: "0.72rem", display: "block", color: recipientType === item.id ? (isBoss ? "#fbbf24" : "#f43f5e") : theme.inputText }}>{item.label}</strong>
                      <span style={{ fontSize: "0.6rem", color: theme.textMuted, display: "block", marginTop: "2px" }}>{item.desc}</span>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div style={{ marginTop: "12px", padding: "12px", borderRadius: "12px", background: theme.subBg, border: theme.subBorder }}>
                {recipientType === "individual" && (
                  <div>
                    <label style={{ fontSize: "0.68rem", fontWeight: 800, color: theme.textMuted }}>Select Specific Employee</label>
                    <select
                      value={selectedRecipientId}
                      onChange={e => setSelectedRecipientId(e.target.value === "" ? "" : Number(e.target.value))}
                      required
                      style={{ width: "100%", padding: "6px 8px", borderRadius: "6px", border: `1px solid ${theme.inputBorder}`, background: theme.inputBg, color: theme.inputText, marginTop: "6px", outline: "none", fontSize: "0.75rem" }}
                    >
                ...
                {recipientType === "tl-team" && (
                  <div>
                    <label style={{ fontSize: "0.68rem", fontWeight: 800, color: theme.textMuted }}>Select Target TL Node</label>
                    <select
                      value={selectedRecipientId}
                      onChange={e => setSelectedRecipientId(e.target.value === "" ? "" : Number(e.target.value))}
                      required
                ...
                {recipientType === "multiple" && (
                  <div>
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "6px" }}>
                      <label style={{ fontSize: "0.68rem", fontWeight: 800, color: theme.textMuted }}>Select Target Recruiters</label>
                      <button type="button" onClick={handleSelectAllRecruiters} style={{ border: "none", background: "none", color: isBoss ? "#fbbf24" : "#f43f5e", fontSize: "0.7rem", fontWeight: 800, cursor: "pointer" }}>
                        {selectedRecipientIds.length === myRecruiters.length ? "Deselect All" : "Select All Recruiters"}
                      </button>
                    </div>
                    <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "6px", maxHeight: "150px", overflowY: "auto" }}>
                      {myRecruiters.map(r => (
                        <label
                          key={r.id}
                          style={{
                ...
                {recipientType === "multiple-tls" && (
                  <div>
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "6px" }}>
                      <label style={{ fontSize: "0.68rem", fontWeight: 800, color: theme.textMuted }}>Select Target Team Leaders</label>
                      <button type="button" onClick={handleSelectAllTls} style={{ border: "none", background: "none", color: isBoss ? "#fbbf24" : "#f43f5e", fontSize: "0.7rem", fontWeight: 800, cursor: "pointer" }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(5, 1fr)", gap: "6px", marginTop: "6px" }}>
                  {[
                    ...
                    >
                      ...
                      <strong style={{ fontSize: "0.65rem", display: "block", marginTop: "2px", color: giftType === g.id ? (isBoss ? "#fbbf24" : "#10b981") : theme.inputText }}>{g.label}</strong>
                    </div>
                  ))}
                </div>
              </div>
