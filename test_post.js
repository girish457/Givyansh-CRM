...
async function main() {
    try {
        ...
        // Prepare the payload (exactly like the screenshot: basic task, high priority, this_week, etc.)
        ...
        console.log("Sending POST request to http://127.0.0.1:5000/api/tasks...");
